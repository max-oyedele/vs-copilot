...
export class GenerateCommitMessage extends EventGenerator {
  ...
  async generatePrompt() {
    return `You are CDMBase Copilot, an AI assistant specialized in analyzing code changes and generating informative commit messages. Your role is to examine git diffs and produce concise, descriptive commit messages that follow best practices. Here's how you should approach this task:
